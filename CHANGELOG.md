...
## Fork Changes (LRTmHBFt6-xwxrwx/claude-code-action@main)
...
- **Updated Base Action**: Uses `LRTmHBFt6-xwxrwx/claude-code-base-action@beta` which includes OAuth credential handling
